...
//}
//
//void StageSelectPlayer::PostUpdate()
//{
//	// ポーズ画面中は更新しない
//	if (m_pauseFlg == true) return;
//
...
//}
//
//void StageSelectPlayer::GenerateDepthMapFromLight()
//{
//	if (m_spModel)
//	{
...
//}
//
//void StageSelectPlayer::DrawLit()
//{
//	if (m_spModel)
//	{
//		if (m_damage.drawFlg || m_aliveFlg == false)
...
//}
//
//void StageSelectPlayer::BackPos()
//{
//	m_pos.x = m_oldPos.x;
//	m_pos.z = m_oldPos.z;
//}
//
//const bool StageSelectPlayer::IsCameraTracking() const
//{
//	// 当たった地面がある時
...
//
//// 当たり判定
//void StageSelectPlayer::HitJudge()
//{
//	// 当たったオブジェクトリストをリセット
...
//}
//
//void StageSelectPlayer::HitJudgeGround()
//{
//	// 動く床関連をリセット
//	// 動く床
...
//}
//
//void StageSelectPlayer::HitJudgeEvent()
//{
//	// ボックス判定
//	{
//		// ボックス判定
...
//}
//
//void StageSelectPlayer::HitJudgeEnemy()
//{
//	// スフィアの情報
//	//KdCollider::SphereInfo sphereInfo;
//	//// スフィアの中心座標
...
//}
//
//void StageSelectPlayer::HitJudgeCarryObject()
//{
...
//}
//
//void StageSelectPlayer::DamageProcess()
//{
//	// 生きている時だけ
//	if (m_aliveFlg == true)
//	{
...
//}
//
//void StageSelectPlayer::GoalProcess()
//{
//	m_goalStayCount++;
