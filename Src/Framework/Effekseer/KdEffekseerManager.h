...
public:
	...
	// Effekseerエフェクト再生
	std::weak_ptr<KdEffekseerObject> Play(const std::string& effName, const DirectX::SimpleMath::Vector3& pos, const DirectX::SimpleMath::Vector3& angle, const float size = 1, const float speed = 1, const bool isLoop = true);
